...
storiesOf('Avatar', module)
  ...
  .addWithInfo('Examples','Examples of Avatar using an image, Font Icon, SVG Icon and "Letter" (string), with and without custom colors at the default size (40dp) and an alternate size (30dp).', () => (
    <List>
        <ListItem
          disabled={true}
          leftAvatar={
